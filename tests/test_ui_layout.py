...
class TestPrimaryLayout(unittest.TestCase):
    ...
    def test_model_comparison_panel(self) -> None:
        ...
        self.assertEqual(panel.helper_label.objectName(), "comparisonHelperLabel")
        self.assertIn("Single-image only", panel.helper_label.text())
        self.assertEqual(panel.model_b_label.text(), "Model B (optional)")
